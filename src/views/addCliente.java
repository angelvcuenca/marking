...
public class addCliente extends javax.swing.JInternalFrame {
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if (filaEditar >= 0 && numfilas == 1) {
            ...
            cliente_id_hidden.setText(cedula_selec);
            txt_names.setText(data_clien);
            txt_celular.setText(celular);
            txt_fono_casa.setText(tel_casa);
            txt_fono_trabajo.setText(fono_trabajo);
            txt_dirc_casa.setText(dir_casa + "/" + nro_casa);
            txt_direc_trabajo.setText(dire_trabajo);
